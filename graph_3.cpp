...
void data_recup(string particle, vector<double>& xData, vector<double>& yData) {
    xData.clear();
    yData.clear();
...
int main() {
    ...
    data_recup("kaon+.txt", xData, yData);
    auto graph2 = new TGraph(xData.size(), &xData[0], &yData[0]);
    ...
    data_recup("mu+.txt", xData, yData);
    auto graph3 = new TGraph(xData.size(), &xData[0], &yData[0]);
